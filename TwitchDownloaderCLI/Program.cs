...
namespace TwitchDownloaderCLI
{
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            var parserResult = parser.ParseArguments<VideoDownloadArgs, ClipDownloadArgs, ChatDownloadArgs, ChatUpdateArgs, ChatRenderArgs, CombinedRenderArgs, InfoArgs, FfmpegArgs, CacheArgs, UpdateArgs, TsMergeArgs>(preParsedArgs);
            ...
            parserResult
                ...
                .WithParsed<CombinedRenderArgs>(CombinedRender.Render)
